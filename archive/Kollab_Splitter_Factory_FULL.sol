...
contract Kollab_Splitter_Factory_Full {

    address payable private owner;
    uint public creationFee;
    uint public withdrawlFee;
    ...
    constructor() {
        ...
        creationFee = 10; // thousands of an ether
        withdrawlFee = 1; // thousands of an ether
        idTracker = 100;
    }
...
contract Kollab_Splitter {
    ...
    function changeFee(uint _fee) onlyFactory public {
        fee = _fee;
    }
